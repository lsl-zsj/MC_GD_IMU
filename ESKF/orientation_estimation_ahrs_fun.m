function out=orientation_estimation_ahrs_fun(acc,gyro,mag,fs,MagSth)

%% construct error state Kalman function
  dT=1/fs;
  cOrientErrVar    = deg2rad(1)*deg2rad(1)*2000e-5; % var in init orientation error estim. 6.0923e-06
  cGyroBiasErrVar  = deg2rad(1)*deg2rad(1)*250e-3; % var in init gyro bias error estim 7.6154e-05
