function out=orientation_estimation_ahrs_mkmc_fun_debug_gn(acc,gyro,mag,fs,sigma_x,sigma_y)

% gravity negative
%   acc=[-0.0389843732,0.01461914,10.2358341];
%   gyro=[0.00746094389,0.00879325531,0.00266462285];
%   mag=[3.75000024,-31.6500015,4.05000019];
